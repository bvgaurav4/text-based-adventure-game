                ...
                def buttonhdl2():
                    ...
                    def s3():
                        ...
                        def buttonhdl3():
                            c7.deselect()
                            c8.deselect()
                            st.insert(END," hmm cart trails hmm i guess they used a to steal my fortune")
                            ...
                            def s4():
                                ...
                                def buttonhdl2():
                                    ...
                                    def s7():
                                        ...
                                        def buttonhdl1():
                                            ic1.deselect()
                                            st.insert(END,"the apparatus (-_-)->(>_<)->(*,*) ")
                                        def buttonhdl2():
                                            ic.deselect()
                                            st.insert(END,"the apparatus (-_-)->(>_<)->(*,*) ")
                                        ic.configure(command=buttonhdl1)
                                        ic1.configure(command=buttonhdl2)
                                    s7()
